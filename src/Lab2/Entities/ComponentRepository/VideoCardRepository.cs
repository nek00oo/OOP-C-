...
public class VideoCardRepository
{
    ...
    public VideoCardRepository()
    {
        ...
        {
            new Models.VideoCard.VideoCard(new SizeType(146, 69), new CountType(2), new PciEVersion.V2(), new CountType(954), new CountType(19)),
            new Models.VideoCard.VideoCard(new SizeType(327, 137), new CountType(12), new PciEVersion.V2(), new CountType(2150), new CountType(250)),
            new Models.VideoCard.VideoCard(new SizeType(342, 150), new CountType(24), new PciEVersion.V4(), new CountType(2235), new CountType(300)),
        };
    }
